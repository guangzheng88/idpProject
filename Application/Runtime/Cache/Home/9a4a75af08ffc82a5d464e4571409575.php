...
<div class="login">
    ...
    <div class="login-top">
        <h1>LOGIN FORM</h1>
            <input type="text" name="username" value="" placeholder="username"  id="uname">
            <input type="password" name="password" value="" placeholder="password" id="upwd" >
            <input type="password" name="repassword" value="" placeholder="password" id="rpwd" >
            <p><span class="red msg"></span></p>
            <div class="forgot">
                <a href="/index.php/index/index" >返回</a>

            </div>
    </div>
    <div class="login-bottom">
        <h3 onclick="checkForm();"  ><a href="javascript:void(0);" >注册 </a></h3>
